...
int main()
{
    ...
    do
    {
        ...
        {   
            ...
            //read all at once such as first name, last, ect then stwich for each unique ones
            ...
            case 3://Hourly employee
                ...
                cin >> stringInput;
                hourlyEmployee.setWeeklyPay(stringInput, &methodStatus);//not in his but need it
                while (!methodStatus)
                {
            ...
            case 4:
                ...
                cin >> stringInput;
                hourlyEmployeePay.setWeeklyPay(stringInput, &methodStatus);//not in his but need it
                while (!methodStatus)
                {
                    cout << "Error, enter a value between 400-3000: ";
                    cin >> stringInput;
            ...
            case 5:
                ...
                cin >> stringInput;
                agencyEmployeePay.setWeeklyPay(stringInput, &methodStatus);//not in his but need it
                while (!methodStatus)
                {
                    cout << "Error, enter a value between 400-3000: ";
                    cin >> stringInput;
